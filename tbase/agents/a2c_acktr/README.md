...
- Baselines post: TODO
- `python3 -m tbase.run --alg=a2c_acktr --scenario=average --max_iter_num=50000 --policy_net=LSTM_MLP_A2C --value_net=LSTM_MLP_A2C --seed 9 --t_max 400 --print_action` runs the algorithm for about 122000 days = 500 episode on a tgym.average environment. See help (`-h`) for more options.
